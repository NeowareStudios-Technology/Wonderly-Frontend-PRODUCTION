...
public class ImageTargetSetter : MonoBehaviour {
	...
	public Dictionary<string, DynamicImageTargetBehaviour> imageTargetDic = new Dictionary<string, DynamicImageTargetBehaviour>();
	...
	void Update()
    {
            ...
            if (obj.Key == "targetPhoto1")
            {
                ...
                if (itm.target1.GetComponent<DynamicImageTargetBehaviour>() == null)
                {
                    ...
                    if (targetThumbCheck[0] == 0 && File.Exists(fm.targetPath1))
                    {
                        ...
                        if (targetThumbs[0].sprite == IMG2Sprite.LoadNewSprite(fm.targetPath1))
                ...
                if (targetThumbCheck[1] == 0 && File.Exists(fm.targetPath2))
					{
                        ...
                        if (targetThumbs[1].sprite == IMG2Sprite.LoadNewSprite(fm.targetPath2))
      ...
      /* 
            else if (obj.Key == "targetPhoto3")
            {
                ...
                if (targetThumbCheck[2] == 0 && File.Exists(fm.targetPath3))
                {
                    targetThumbs[2].sprite = IMG2Sprite.LoadNewSprite(fm.targetPath3);
                    targetThumbCheck[2] = 1;
                    if (targetThumbs[2].sprite == IMG2Sprite.LoadNewSprite(fm.targetPath3))
                            targetThumbCheck[2] = 1;
                }
            ...
            else if (obj.Key == "targetPhoto4")
            {
                ...
                if (targetThumbCheck[3] == 0 && File.Exists(fm.targetPath4))
                {
                    targetThumbs[3].sprite = IMG2Sprite.LoadNewSprite(fm.targetPath4);
                    if (targetThumbs[3].sprite == IMG2Sprite.LoadNewSprite(fm.targetPath4))
                            targetThumbCheck[0] = 1;
                }
                ...
                if (targetThumbCheck[4] == 0 && File.Exists(fm.targetPath5))
					{
						...
						if (targetThumbs[4].sprite == IMG2Sprite.LoadNewSprite(fm.targetPath5))

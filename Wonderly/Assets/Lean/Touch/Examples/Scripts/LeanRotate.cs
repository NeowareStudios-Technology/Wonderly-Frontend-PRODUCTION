...
namespace Lean.Touch
{
	...
	{	
		public leanTouchAxis leanTouchRotation;
		...
		protected virtual void Rotate(float twistDegrees)
		{
			...
			if (camera != null)
			{
				...
				Debug.Log("BIGGGG LEAN " + leanTouchRotation.rotationAxis);
				switch(leanTouchRotation.rotationAxis){
					case 0:
						axis = new Vector3(axis.x  + 90.0f, axis.y, axis.z);
					...
					case 1:
						...
						break;
					case 2:
						axis = new Vector3(axis.x, axis.y, axis.z + 90.0f);
						transform.rotation *= Quaternion.AngleAxis(twistDegrees, axis);
						break;
				}
